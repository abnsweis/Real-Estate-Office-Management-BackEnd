...
namespace RealEstate.Application.Features.Rentals.Querys
{
    ...
    public class GetRentalsByPropertyIdQuery : IRequest<AppResponse<PaginationResponse<RentalDTO>>>
    {
        
        public PaginationRequest Pagination { get; set; }
        public Guid PropertyId { get; }

        public GetRentalsByPropertyIdQuery(PaginationRequest pagination, Guid propertyId)
        {
    ...
    /// <summary>
    /// Handler for the GetRentalsByPropertyIdQuery that retrieves Rentals from the repository
    /// </summary>
    public class GetRentalsByPropertyIdQueryHandler : IRequestHandler<GetRentalsByPropertyIdQuery, AppResponse<PaginationResponse<RentalDTO>>>
    {
        ...
        public GetRentalsByPropertyIdQueryHandler(
        ...
        public async Task<AppResponse<PaginationResponse<RentalDTO>>> Handle(GetRentalsByPropertyIdQuery request, CancellationToken cancellationToken)
        {
