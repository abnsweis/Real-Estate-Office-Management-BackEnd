...
namespace RealEstate.Application.Features.Rentals.Querys
{
    ...
    public class GetRentalsByLessorIdQuery : IRequest<AppResponse<PaginationResponse<RentalDTO>>>
    {
        
        public PaginationRequest Pagination { get; set; }
        public Guid LessorId { get; }

        public GetRentalsByLessorIdQuery(PaginationRequest pagination, Guid lessorId)
        {
    ...
    /// <summary>
    /// Handler for the GetRentalsByLessorIdQuery that retrieves Rentals from the repository
    /// </summary>
    public class GetRentalsByLessorIdQueryHandler : IRequestHandler<GetRentalsByLessorIdQuery, AppResponse<PaginationResponse<RentalDTO>>>
    {
        ...
        public GetRentalsByLessorIdQueryHandler(
        ...
        public async Task<AppResponse<PaginationResponse<RentalDTO>>> Handle(GetRentalsByLessorIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var Rentals = await _rentalsRepository.GetAllAsync(
                ...
                filter : s => s.LessorId == request.LessorId,
