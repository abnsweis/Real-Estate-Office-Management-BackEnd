...
namespace RealEstate.Application.Features.Rentals.Querys
{
    ...
    public class GetAllRentalsQuery : IRequest<AppResponse<PaginationResponse<RentalDTO>>>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the GetAllRentalsQuery class
        /// </summary>
        /// <param name="pagination">Pagination parameters</param>
        /// <param name="filter">Filter criteria</param>
        public GetAllRentalsQuery(PaginationRequest pagination)
        {
    ...
    /// <summary>
    /// Handler for the GetAllRentalsQuery that retrieves Rentals from the repository
    /// </summary>
    public class GetAllRentalsQueryHandler : IRequestHandler<GetAllRentalsQuery, AppResponse<PaginationResponse<RentalDTO>>>
    {
        ...
        public async Task<AppResponse<PaginationResponse<RentalDTO>>> Handle(GetAllRentalsQuery request, CancellationToken cancellationToken)
        {
