...
namespace RealEstate.Application.Features.Users.Commands.Create
{
    public class CreateUserValidator : AbstractValidator<CreateUserCommand>
    {
        ...
        public CreateUserValidator()
        {
            ...
            RuleFor(c => c.Data.ConfirmPassword)
                .NotEmpty()
                     .WithMessage("Confirm Password is required.")
                        .WithErrorCode(enApiErrorCode.RequiredField.ToString())
                .Matches(c => c.Data.Password)
                    .WithMessage("ConfirmPassword Not Matches Password Field ")
                    .WithErrorCode(enApiErrorCode.PasswordMismatch.ToString());
        }
