...
namespace RealEstate.Application.Features.Sales.Querys
{
    ...
    public class GetSalesByBuyerIdQuery : IRequest<AppResponse<PaginationResponse<SaleDTO>>>
    {

        public PaginationRequest Pagination { get; set; }
        public Guid BuyerId { get; }

        public GetSalesByBuyerIdQuery(PaginationRequest pagination, Guid buyerId)
        {
    ...
    public class GetSalesByBuyerIdQueryHandler : IRequestHandler<GetSalesByBuyerIdQuery, AppResponse<PaginationResponse<SaleDTO>>>
    {
        ...
        public GetSalesByBuyerIdQueryHandler(
        ...
        public async Task<AppResponse<PaginationResponse<SaleDTO>>> Handle(GetSalesByBuyerIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var sales = await _salesRepository.GetAllAsync(
                ...
                filter: s => s.BuyerId == request.BuyerId,
