...
namespace RealEstate.Application.Features.Sales.Querys
{
    ...
    public class GetSalesBySellerIdQuery : IRequest<AppResponse<PaginationResponse<SaleDTO>>>
    {

        public PaginationRequest Pagination { get; set; }
        public Guid SellerId { get; }

        public GetSalesBySellerIdQuery(PaginationRequest pagination, Guid sellerId)
        {
    ...
    /// <summary>
    /// Handler for the GetSalesBySellerIdQuery that retrieves sales from the repository
    /// </summary>
    public class GetSalesBySellerIdQueryHandler : IRequestHandler<GetSalesBySellerIdQuery, AppResponse<PaginationResponse<SaleDTO>>>
    {
        ...
        public GetSalesBySellerIdQueryHandler(
        ...
        public async Task<AppResponse<PaginationResponse<SaleDTO>>> Handle(GetSalesBySellerIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var sales = await _salesRepository.GetAllAsync(
                ...
                filter: s => s.SellerId == request.SellerId,
